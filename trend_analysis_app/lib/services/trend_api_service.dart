...
class TrendApiService {
  ...
  Future<List<TrendModel>> getAllTrends() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to load trends. Status code: ${response.statusCode}');
    }
  }
  ...
  Future<List<TrendModel>> getTrendsByAttributeType(String attributeType) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to load $attributeType trends. Status code: ${response.statusCode}');
    }
  }
}